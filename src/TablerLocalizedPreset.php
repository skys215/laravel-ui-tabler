...
class TablerLocalizedPreset extends Preset
{
    /** @var Command */
    protected $command;
    ...
    protected static function updateSass()
    {
        ...
        copy(__DIR__.'/../tabler-stubs/bootstrap/_variables.scss', resource_path('sass/_variables.scss'));
    ...
    protected function scaffoldAuth()
    {
        ...
        tap(new Filesystem(), function ($filesystem) {
            $filesystem->copyDirectory(__DIR__.'/../tabler-stubs/auth-localized', resource_path('views/auth'));
            $filesystem->copyDirectory(__DIR__.'/../tabler-stubs/layouts-localized', resource_path('views/layouts'));
            $filesystem->copy(__DIR__.'/../tabler-stubs/home-localized.blade.php', resource_path('views/home.blade.php'));
